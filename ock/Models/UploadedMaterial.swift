...
struct UploadedMaterial: Identifiable, Equatable, Codable {
    ...
    init(id: String = UUID().uuidString, name: String, type: String, size: Int64, fileURL: URL? = nil, extractedText: String? = nil) {
        self.id = id
        self.name = name
        self.type = type
        self.size = size
    ...
    enum CodingKeys: String, CodingKey {
        case id, name, type, size, fileURL, extractedText, textChunks
    }
